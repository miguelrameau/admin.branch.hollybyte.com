...
HB2.admin.asset = ( function($) {
    ...
    function renderAssetContentAction() {
        return '<img class="asset-content-action-reencode" src="' + HB2.admin.staticRepo + '/img/common/reencode.png"/><img class="asset-content-action-download" src="' + HB2.admin.staticRepo + '/img/common/download.png" />';
    }
    ...
    function renderAssetGroupSmil() {
        return '<img class="asset-group-smil-download" src="' + HB2.admin.staticRepo + '/img/common/download.png"/>';
    }
    ...
    function renderAssetSubtitleAction() {
        return '<img class="asset-subtitle-action-download" src="' + HB2.admin.staticRepo + '/img/common/download.png"/><img class="asset-subtitle-action-edit" src="' + HB2.admin.staticRepo + '/img/common/edit.png"/><img class="hb-asset-subtitle-action-delete" src="' + HB2.admin.staticRepo + '/img/common/delete.png" />';
    }
    ...
    function getAssetGroupsData(objs) {
        ...
        for(i in objs) {
            ...
            data[0] = objs[i].name;
            data[1] = objs[i].type;
            if(!HB2.admin.isEmpty(objs[i].smil)) {
                data[2] = objs[i].smil;
            } else {
                data[2] = "";
            }
            if(!HB2.admin.isEmpty(objs[i].contents)) {
        ...
        var ext = obj.source.path.split('.').pop();
            ...
            if(!HB2.admin.isEmpty(obj.contents)) {
                for(var i = 0; i < obj.contents.length; i++) {
                    ...
                    if(ext == 'mp4') {
                        $('#assetPlayer')[0].href = 'http://' + repo + '/' + cont.path;
                    }
                }
         ...
         loadVideoPlayer(obj, "assetPlayer");
         
        /*player = flowplayer("assetPlayer", 'https://hollybyte.s3.amazonaws.com/public/players/flowplayer/swf/flowplayer.commercial-3.2.7.swf', {
            "key" : '#@0b3272bb43eff43967a',
            "play" : {
                "url" : 'https://hollybyte.s3.amazonaws.com/public/players/img/play.png',
                "width" : 78,
                "height" : 78
            },
            "logo" : {
                "url" : 'https://hollybyte.s3.amazonaws.com/public/players/img/logo.png',
            ...
            "plugins" : {
                "controls" : {
                    "url" : 'https://hollybyte.s3.amazonaws.com/public/players/flowplayer/swf/flowplayer.controls-3.2.5.swf',
                    "autoHide" : {
                        "enabled" : true,
                        "fullscreenOnly" : false,
                        "hideDelay" : 1019,
    ...
    function setAssetJSON(obj) {
        ...
        //}
        if(!HB2.admin.isEmpty(obj.youtube)) {
            youtubeLoad();
        } else {
            console.info('Account Type: ', HB2.admin.accountType);
            if((HB2.admin.accountType == "PREMIUM") || (HB2.admin.accountType == "CORPORATE")) {
    ...
    function getYoutubeConnectors() {
        ...
        $.ajax({
            ...
            dataType : 'json',
            success : function(data, textStatus, jqXHR) {
                if(!HB2.admin.isEmpty(data.result)) {
    ...
    function onClickEditSubtitleSave(table) {// MIRAR SI SE PUEDE BORRAR
        ...
        if($.trim($('#subtitleFileValue').val())) {
            ...
            data[3] = '<a href="' + url + '"><img class="asset-subtitle-action-download" src="' + HB2.admin.staticRepo + '/img/common/download.png" /></a><img class="hb-asset-subtitle-action-delete" src="' + HB2.admin.staticRepo + '/img/common/delete.png" onClick="onClickDeleteSubtitle(this, assetSubtitleTable);"/>';
        }
    ...
    function updateSubtitlesTable(table, value) {
        ...
        if(!HB2.admin.isEmpty(value)) {
            ...
            var url = 'https://' + repo + '/' + data[2];
            data[3] = '<a href="' + url + '"><img class="asset-subtitle-action-download" src="' + HB2.admin.staticRepo + '/img/common/download.png" /></a><img class="hb-asset-subtitle-action-delete" src="' + HB2.admin.staticRepo + '/img/common/delete.png"/>';
        ...
        $('.hb-asset-subtitle-action-delete').click(function() {
