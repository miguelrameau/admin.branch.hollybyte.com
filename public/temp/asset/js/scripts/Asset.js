...
var AssetHtml = function (obj) {
    ...
    this.obj.splash = 'http://repo1.eu.hollybyte.com/'+this.obj.splash;
    ...
    if(HB2.admin.allowed('admin-asset-list-embedicons')){
        ...
        this.assetElementTopSocialEmbed.onclick = function(e) {
             ...
             $("#txtEmbed").val('<object class="vjs-flash-fallback"  width="640" height="480" type="application/x-shockwave-flash" data="http://'+repo+'/acc/'+asset.account+'/st/www/default/public/'+flowPath+'"><param name="movie" value="http://'+repo+'/acc/'+asset.account+'/st/www/default/public/'+flowPath+'" /><param name="allowfullscreen" value="true" /><param name="width" value="640" /><param name="height" value="480" /><param name="flashvars" value="config=http://'+repo+'/acc/'+asset.account+'/st/www/default/public/js/emb/'+obj.id+'.js" /></object>');        
        };
        ...
        this.assetElementTopSocialEmbedImg.setAttribute("src", "images/connector/embed.png");
        ...
        this.assetElementTopSocialIframe.onclick = function(e) {
             $("#assetlistEmbedDialog").dialog('open');
             var domain = "www." + asset.account + '.'+HB2.admin.getRegionCode(obj.region)+'.hollybyte.tv';
             
             $("#txtEmbed").val('<iframe frameborder="0" marginwidth="0" marginheight ="0" id="iframeId" width="640" height="480" src="http://'+domain+'/embed/'+obj.id+'"></iframe>');
        ...
        this.assetElementTopSocialIframeImg.setAttribute("src", "images/connector/iframe.png");
    ...
    if( HB2.admin.allowed('admin-asset-list-edit') ){
        ...
        this.assetElementTopActionsEditImg.setAttribute("src", "images/assetlist/asset_edit.png");
    ...
    if(HB2.admin.allowed('admin-asset-list-delete')){
        ...
        this.assetElementTopActionsDeleteImg.setAttribute("src", "images/assetlist/asset_delete.png");
    ...
    if(this.obj.type == "IMAGE")
        this.assetElementTopTypeImg.setAttribute("src", "images/assetlist/type_image.png");
    else if(this.obj.type == "AUDIO")
        this.assetElementTopTypeImg.setAttribute("src", "images/assetlist/type_audio.png");
    else
        this.assetElementTopTypeImg.setAttribute("src", "images/assetlist/type_video.png");
